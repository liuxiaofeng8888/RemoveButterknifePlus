...
public class DetectOnClickChain extends BaseChain {
    ...
    private Map<ClickMethod, List<String>> methodAndIDMap;
    private ClickMethod method;
    private List<String> ids;

    public DetectOnClickChain(Map<ClickMethod, List<String>> map){
        methodAndIDMap = map;
    }
    @Override
    public void process() {
    ...
    private List<String> detectID(String s, ClickMethod mehtod) {
        List<String> idList;
        if (s.contains("{")){
    ...
    private ClickMethod detectMethod(String s) {
        ClickMethod method = new ClickMethod();
    ...
    private void setMethod(String element,ClickMethod method) {
